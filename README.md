...
- **[/worker](./worker)**: Node.js Worker Pool Orchestrator. Manages Next.js preview instances on EC2.
...
3.  **Worker**: Deploy to a dedicated EC2 instance (Ubuntu) to handle heavy Next.js compilation workloads.
